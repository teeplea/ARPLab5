...
import sys
sys.path.append('/home/acampbe/Eigendoit/pwr/cmslink/ARPLab5/scoping_nrm/nrm')
sys.path.append('/home/acampbe/Eigendoit/pwr/cmslink/ARPLab5/scoping_nrm/nrm/examples/casmo4_examples')
...
enrich = np.array([4.93,4.94,4.95])
